...
var palindrome = function(string) {
  ...
  if(string[0].toLowerCase() === string[string.length - 1].toLowerCase()){
    return palindrome(string.slice(1, (string.length - 1 )).trim())
  }
  return false;
};
...
var capitalizeFirst = function(array) {
  ...
  var word = array.shift();
    return [word[0].toUpperCase() + word.slice(1).toLowerCase()].concat(capitalizeFirst(array))
};
...
var alternateSign = function(array) {
  ...
  if (array.length % 2 === 1){
    return [-1 * Math.abs(array[0])].concat(alternateSign(array.slice(1)))
  } else {
