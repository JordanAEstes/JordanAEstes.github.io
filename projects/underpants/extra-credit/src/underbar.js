(function() {
  ...
  _.filter = function(collection, test) {
    ...
    _.each(collection, function(item, index){
      if(test(collection[index], index, collection) === true){
        newArray.push(item);
      }
    })
    return newArray;
  ...
  _.reject = function(collection, test) {
    return _.filter(collection, function(elem, index, coll){
        if(test(elem, index, coll) === false){
            return true;
        }
    })
  ...
  _.reduce = function(collection, iterator, accumulator) {
    ...
    //declare prevResult to the accumulator value
    ...
    //set prevResult to the return of the function calling prevResult, element, and index
      prevResult = iterator(prevResult, item, index);
    })
